...
Both backends share the same HTP kernel source tree; users select transport layer via build‑time CMake option, zero breaking changes to upstream default dspqueue workflow.
...
| Model | Layers | Attention | lm_head | Model Size | fastrpc PP | dspqueue PP | PP Diff | fastrpc TG | dspqueue TG | TG Diff |
|-------|-------:|-----------|---------|-----------|------:|--------:|--------:|------:|--------:|--------:|
| qwen1.5-1.8B | 24 | MHA 1:1 | Q6_K | 1.1 GiB | 521.36 | 738.04 | -29.4% | 17.12 | 24.31 | -29.6% |
| minicpm5-1b | 24 | GQA 8:1 (16:2) | Q4_0 | ~0.7 GiB | 1161.77 | 1016.62 | +14.3% | 51.95 | 36.14 | **+43.8%** |
| Llama-3.2-1B | 16 | GQA 4:1 | Q4_K | 0.7 GiB | 1006.10 | 1063.43 | -5.4% | 41.64 | 28.33 | **+47.1%** |
| Qwen3.5-2B | 24 | GQA + Delta | Q6_K | 1.2 GiB | 485.07 | 434.96 | +11.5% | 26.99 | 14.95 | **+80.5%** |
| gemma-4-E2B | 35 | GQA 8:1 | Q4_K | 2.9 GiB | 668.14 | 490.09 | **+36.3%** | 27.00 | 24.99 | +8.0% |
| Nanbeige-3B | 22 | GQA 6:1 | Q4_0 | 2.4 GiB | 224.14 | 136.73 | **+63.9%** | 8.03 | 9.11 | -11.9% |
| gemma-4-E4B | 42 | GQA 4:1 | Q4_K | 4.9 GiB | 403.76 | 426.82 | -5.4% | 14.75 | 12.08 | **+22.1%** |
| Qwen3.5-9B | 32 | GQA + Delta | Q6_K | 5.0 GiB | 11.28 | 114.14 | -90.1% | 5.80 | 6.77 | -14.3% |
