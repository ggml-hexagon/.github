...
4. There is a tricky issue in QKV/FFN NX fusion that gets triggered with `nanbeige-3b-q80` (Nanbeige_Nanbeige4.2-3B-Q8_0.gguf), workaround: add a mempool-pressure gate in Phase 3.
